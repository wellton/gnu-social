 ...
 *
 * Module to enable Single Sign On via CAS (Central Authentication Service)
 *
 * PHP version 5
 *
...
class CasAuthenticationModule extends AuthenticationModule
{
    ...
    function onInitializeModule(){
        parent::onInitializeModule();
    ...
    function onModuleVersion(array &$versions)
    {
        $versions[] = array('name' => 'CAS Authentication',
                            ...
                            // TRANS: Module description. CAS is Central Authentication Service.

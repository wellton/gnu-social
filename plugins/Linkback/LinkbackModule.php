 ...
 *
 * Module to do linkbacks for notices containing links
 *
 * PHP version 5
 *
...
/**
 * Module to do linkbacks for notices containing URLs
 *
 ...
 * @see      Event
 */
class LinkbackModule extends Module
{
    var $notice = null;
    ...
    function onHandleQueuedNotice(Notice $notice)
    {
        ...
        if (!$notice->getProfile()->getPref('LinkbackModule', 'disable_linkbacks')) {
            // Ignoring results

 ...
 *
 * Module to check submitted notices with Mollom
 *
 * PHP version 5
 *
 ...
 * @see      Event
 */
class MollomModule extends Module
{
    public $public_key;
    public $private_key;
    public $servers;
    ...
    function xmlrpc($url) {
      ...
      $args = func_get_args();
      return call_user_func_array(array('MollomModule', '_xmlrpc'), $args);
    }
    ...
    function xmlrpc_message_parse(&$xmlrpc_message) {
      ...
      xml_set_element_handler($xmlrpc_message->_parser, array('MollomModule', 'xmlrpc_message_tag_open'), array('MollomModule', 'xmlrpc_message_tag_close'));
      xml_set_character_data_handler($xmlrpc_message->_parser, array('MollomModule', 'xmlrpc_message_cdata'));

 ...
 *
 * Module to do "real time" updates using Orbited + STOMP
 *
 * PHP version 5
 *
...
/**
 * Module to do realtime updates using Orbited + STOMP
 *
 ...
 * @link     http://laconi.ca/
 */
class OrbitedModule extends RealtimeModule
{
    ...
    function onModuleVersion(array &$versions)
    {
        $versions[] = array('name' => 'Orbited',
                            ...
                            _m('Module to make updates using Orbited and STOMP.'));
        return true;
    }
}

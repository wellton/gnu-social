...
/**
 * A sample module to show best practices for GNU social plugins
 *
 * @package   GNU social
 ...
 *
 * The main class usually extends the Module class that comes with StatusNet.
 *
 ...
 *     addPlugin('Sample');
 *
 * Modules must be installed in one of the following directories:
 *
 ...
 * the name of the main class, like 'SampleModule'. Modules that are part of the
...
class SampleModule extends Module
{
    ...
    /**
     * Modules are configured using public instance attributes. To set
     ...
     *
     * Modules overload this method to do any initialization they need,
     ...
     *
     * Modules overload this method to do any cleanup they need,
     ...
     *
     * Modules can add their own tables to the StatusNet database. Modules

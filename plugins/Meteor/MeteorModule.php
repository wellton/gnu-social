 ...
 *
 * Module to do "real time" updates using Meteor
 *
 * PHP version 5
 *
...
/**
 * Module to do realtime updates using Meteor
 *
 * @category Module
 * @package  StatusNet
 * @author   Evan Prodromou <evan@status.net>
 ...
 * @link     http://status.net/
 */
class MeteorModule extends RealtimeModule
{
    ...
    function onModuleVersion(array &$versions)
    {
        $versions[] = array('name' => 'Meteor',
                            ...
                            _m('Module to do "real time" updates using Meteor.'));
        return true;
    }
}

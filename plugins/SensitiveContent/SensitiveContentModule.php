...
class SensitiveContentModule extends Module
{
	...
	{
		$settings['blockerimage'] = Module::staticPath('SensitiveContent', '').'img/blocker.png';
...
EOB;
	...
	{
		$action->script( Module::staticPath('SensitiveContent', '').'js/sensitivecontent.js' );
	}

 ...
 *
 * Module to do "real time" updates using Comet/Bayeux
 *
 * PHP version 5
 *
...
require_once INSTALLDIR . '/plugins/Realtime/RealtimeModule.php';

/**
 * Module to do realtime updates using Comet
 *
 * @category Module
 * @package  StatusNet
 * @author   Evan Prodromou <evan@status.net>
 ...
 * @link     http://status.net/
 */
class CometModule extends RealtimeModule
{
    ...
    function onModuleVersion(array &$versions)
    {
        $versions[] = array('name' => 'Comet',
                            ...
                            'rawdescription' =>
                            // TRANS: Module description message. Bayeux is a protocol for transporting asynchronous messages
                            // TRANS: and Comet is a web application model.
                            _m('Module to make updates using Comet and Bayeux.'));
        return true;
    }
}

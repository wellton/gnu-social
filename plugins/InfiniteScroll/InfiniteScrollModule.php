...
class InfiniteScrollModule extends Module
{
    ...
    function onModuleVersion(array &$versions)
    {
        $versions[] = [
            ...
            _m('Infinite Scroll adds the following functionality to your GNU social installation: When a user scrolls towards the bottom of the page, the next page of notices is automatically retrieved and appended. This means they never need to click "Next Page", which dramatically increases stickiness.')
        ];
        return true;
    }
}

 ...
 *
 * Module to push RSS/Atom updates to a PubSubHubBub hub
 *
 * PHP version 5
 *
...
class PtitUrlModule extends UrlShortenerModule
{
    ...
    function onModuleVersion(array &$versions)
    {
        $versions[] = array('name' => sprintf('PtitUrl (%s)', $this->shortenerName),
                            ...
                            'rawdescription' =>
                            // TRANS: Module description. %1$s is the URL shortening service base URL (for example "bit.ly").

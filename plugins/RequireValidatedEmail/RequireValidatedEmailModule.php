 ...
 *
 * Module that requires the user to have a validated email address before they
 * can post notices
 *
 * PHP version 5
 *
...
/**
 * Module for requiring a validated email before posting.
 *
 ...
 * @link      http://status.net/
 */
class RequireValidatedEmailModule extends Module
{
     ...
     *
     * addPlugin('RequireValidatedEmailModule', array(
    ...
    protected function validated(User $user)
    {
        ...
        Event::handle('RequireValidatedEmailModule_Override',

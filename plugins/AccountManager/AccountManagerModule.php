 ...
 *
 * Module to implement the Account Manager specification
 *
 * PHP version 5
 *
...
class AccountManagerModule extends Module
{
    ...
    function onStartHostMetaLinks(&$links) {
        $links[] = new XML_XRD_Element_Link(AccountManagerModule::AM_REL,
    ...
    function onStartShowHTML($action)
    {
        ...
        header('Link: <'.common_local_url('AccountManagementControlDocument').'>; rel="'. AccountManagerModule::AM_REL.'"; type="application/json"');
